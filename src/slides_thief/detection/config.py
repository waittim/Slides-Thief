...
DETECTION_CONFIG = {'version': 1,
 'deduplication': {'iouThreshold': 0.94, 'cornerDistanceThreshold': 0.012},
 'geometry': {'minimumAreaRatio': 0.08,
              'boundsRatio': 0.2,
              'minimumEdgeRatio': 0.1,
              'minimumAngleDegrees': 12,
              'maximumAngleDegrees': 168},
 'contrastLines': {'horizontalSampleCount': 180,
                   'verticalSampleCount': 170,
                   'horizontalOffsetRatio': 0.017,
                   'verticalOffsetRatio': 0.012,
                   'minimumOffset': 5,
                   'topRange': [0.07, 0.45],
                   'bottomRange': [0.42, 0.92],
                   'leftRange': [0.01, 0.46],
                   'rightRange': [0.54, 0.99],
                   'horizontalStepDivisor': 220,
                   'verticalStepDivisor': 240,
                   'horizontalSlopeRange': [-0.22, 0.16],
                   'verticalSlopeRange': [-0.24, 0.24],
 ...
 'maskLines': {'grayPercentiles': {'lower': 0.25, 'threshold': 0.55, 'highlight': 0.92},
               'thresholdOffset': 5,
               ...
               'fitOutlierFloor': 3,
               'fitIterations': 3,
               'variants': [{'name': 'fitted', 'scale': 1},
                            {'name': 'inset', 'scale': 0.985},
                            {'name': 'outset', 'scale': 1.015}]},
 'gradient': {'pyramidScales': [1, 0.67, 0.45],
              'thresholdFloor': 0.035,
              'thresholdPercentile': 0.85,
              'magnitudeScaleExponent': 0.5},
 'houghLines': {'angleBins': 90,
                'rhoStep': 3,
 ...
 'scoring': {'weights': {'edgeStrength': 0.24,
                         'edgeSupport': 0.22,
                         'edgeContinuity': 0.03,
             ...
             'formulaWeights': {'bestScore': 0.3,
                                'margin': 0.25,
                                'edgeSupport': 0.2,
                                'detectorAgreement': 0.15,
                                'geometryValidity': 0.1}},
 'confidence': {'autoReviewThreshold': 0.68,
                'marginScale': 0.18,
 ...
 'refinement': {'movementRatio': 0.04,
                ...
                'edgeObjectiveWeights': {'edgeStrength': 0.35,
                                         'edgeSupport': 0.3,
                                         'edgeContinuity': 0.2,
                                         'gradientAlignment': 0.1,
                                         'signedContrast': 0.05}},
 'fallback': {'marginXRatio': 0.045, 'marginYRatio': 0.055}}
